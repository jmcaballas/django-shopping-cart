...
```
cd existing_repo
git remote add origin https://gitlab.icannhas.com/joseph/django-training-cart.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.icannhas.com/joseph/django-training-cart/-/settings/integrations)
